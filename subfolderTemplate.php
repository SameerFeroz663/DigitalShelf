...
if($parts[1] == $brand['id']){
    ...
    <li class="sidebar-item mt-10 mb-10 text-light" id="index">
              <a class="sidebar-link" style="border-radius: 45px;font-weight: lighter !important;" href="../../' .$brand['id']. '/index.php" aria-expanded="false">
                <i class="ti ti-layout-dashboard" style="border-radius: 45px;align-items: center !important; text-align: center; padding-top: 3.5px; padding-bottom: 3.5px;" ></i>
                
                <span class="hide-menu " >' . $brand['name'].'</span>
              </a>
            </li>
    ';
    ...
    echo '<li class="sidebar-item mt-10" id="brand_' . $brand['id'] . '" >
            <a class="sidebar-link" href="../../' .$brand['id']. '/index.php" aria-expanded="false">
...
while ($brand1 = mysqli_fetch_assoc($brand_result1)) {
    echo '<li class="sidebar-item mt-10" id="brand_' . $brand1['id'] . '">
            <a class="sidebar-link" href="../' .$brand1['id']. '/index.php" aria-expanded="false">
                <i class="ti ti-briefcase"></i>
    ...
    if (icon && searchContainer) {
      ...
      <div class="body-wrapper-inner">
        <div class="container-fluid">
          <!--  Row 1 -->
         <div class="card p-5">
             <h2><?php echo $parts[0]. '/' . $fetch['name'] . '/' . $parts[2] . '/..';?></h2>
             ...
             foreach($path as $items){
                ...
                $itemPath = $pathIncom . "/" . $items;
                    echo "<a href='$itemPath/index.php'><div class='dirs'>" . $items . "<br><i class='ti ti-file'></i><a href='$itemPath' download><i class='ti ti-download'></i></a> </div> </a>";
            }
