...
if($_SERVER['REQUEST_METHOD'] == "POST"){
  ...
  $insert = "INSERT INTO user_invitation(email,username,token) VALUES('$email','$username','$token')";
  $res = mysqli_query($conn,$insert);
  if($res){
      $invitationLink = "digitalshelf.sausinternationalinc.com/authenticate/activation.php?token=$token";
      $subject = "Your'e Invited To Join";
      $body = 
      "Hi $username,
    ...
    $headers = "From: ferozsameer07@gmail.com \r\n";
    $headers .= "Content-Type:text/plain; charset=UTF-8\r\n";
    if(mail($email,$subject,$body,$headers)){
        header('location:../index.php?from=mailsent');
    }
    else{
        echo "Invalid Email";
    }
...
<div class="body-wrapper-inner">
  <div class="container-fluid -mt-2">
      ...
      <form method="post" action="" style="padding: 40px;">
        ...
        <!-- Role Dropdown -->
        <div class="mb-4">
          <label for="role" class="form-label fw-semibold">Enter Member Email</label>
            <input type="email" required name="email" class="form-control"/>
        </div>
         <div class="mb-4">
          <label for="role" class="form-label fw-semibold">Enter Member Username</label>
