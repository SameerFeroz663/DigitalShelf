...
if($_SERVER['REQUEST_METHOD'] == "POST"){
  ...
  $brandid = $_POST['brands'];
   foreach ($brandid as $brand) {
        ...
        if ($res) {
            header('Location: ../index.php?from=userSuccess');
            exit();
        } else {
...
<head>
  ...
  <title>Assign Brand - Digital Shelf</title>
          ...
          <div class="border rounded p-4 shadow-sm" style="max-height: 300px; overflow-y: auto; background-color: #f9f9f9;">
            ...
            while ($fetch = mysqli_fetch_array($res)) {
                ...
                <div class="form-check mb-3 d-flex align-items-center gap-2">
                  <input class="form-check-input" type="checkbox" name="brands[]" value="' . $fetch[0] . '" id="brand' . $fetch[0] . '" style="transform: scale(1.5);">
